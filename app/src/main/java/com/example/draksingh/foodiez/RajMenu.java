...
import static com.example.draksingh.foodiez.RajFlavorAdapter.selectedString;
import static com.example.draksingh.foodiez.RajFlavorAdapter.selectedStrings;

/**
 * {@link MainActivity} shows a list of Android platform releases.
 * For each release, display the name, version number, and image.
 */
public class RajMenu extends AppCompatActivity {
    RajFlavorAdapter flavorAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create an ArrayList of RajFlavor objects
        ArrayList<RajFlavor> rajFlavors = new ArrayList<RajFlavor>();
        ...
        */
        rajFlavors.add(new RajFlavor("Samosa", "Rs.5", R.drawable.r_samosa));
        rajFlavors.add(new RajFlavor("Bhaji Samosa", "Rs.20", R.drawable.r_bhaji_samosa));
        rajFlavors.add(new RajFlavor("Aloo Parathe", "Rs.40", R.drawable.r_aloo_parathe));
        rajFlavors.add(new RajFlavor("Aloo Pyaaz Parathe", "Rs.40", R.drawable.r_aloo_pyaaz));
        rajFlavors.add(new RajFlavor("Paneer Parathe", "Rs.40", R.drawable.r_paneer_parathe));
        rajFlavors.add(new RajFlavor("Hot Dog", "Rs.20", R.drawable.r_hot_dog));
        rajFlavors.add(new RajFlavor("Egg Hot Dog", "Rs.20", R.drawable.r_egg_hot_dog));
        rajFlavors.add(new RajFlavor("Plain Maggi", "Rs.20", R.drawable.r_plain_maggi));
        rajFlavors.add(new RajFlavor("Fried Maggi", "Rs.25", R.drawable.r_fried_maggi));
        rajFlavors.add(new RajFlavor("Burger", "Rs.20", R.drawable.r_burger));
        rajFlavors.add(new RajFlavor("Dosa", "Rs.40", R.drawable.r_dosa));
        rajFlavors.add(new RajFlavor("Pav Bhaji", "Rs.35", R.drawable.r_pav_bhaji));
        rajFlavors.add(new RajFlavor("Cold Drink", "Rs.40", R.drawable.r_cold_drinks));
        rajFlavors.add(new RajFlavor("Coffee", "Rs.15", R.drawable.r_coffee));
        rajFlavors.add(new RajFlavor("Chai", "Rs.10", R.drawable.r_chai));
        // Create an {@link RajFlavorAdapter}, whose data source is a list of
        // {@link RajFlavor}s. The adapter knows how to create list item views for each item
        // in the list.
        flavorAdapter = new RajFlavorAdapter(this, rajFlavors);
    ...
    public void proceedToContinue(View view) {
       ...
       // Toast.makeText(getBaseContext(), ""+ selectedString, Toast.LENGTH_SHORT).show();
        ...
        {   ContentValues values = new ContentValues();
            ...
            values.put(TempOrders.CANTEEN, "RAJ");
...
*/
       ...
       // Toast.makeText(getBaseContext(), "ADDED", Toast.LENGTH_SHORT).show();
        Intent i1 = new Intent(RajMenu.this, confirmation.class);
