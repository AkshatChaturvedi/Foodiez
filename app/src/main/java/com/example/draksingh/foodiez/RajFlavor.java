...
/**
 * {@link RajFlavor} represents a single Android platform release.
 * Each object has 3 properties: name, version number, and image resource ID.
 */
public class RajFlavor {
    ...
    /*
    * Create a new RajFlavor object.
    *
    * @param vName is the name of the Android version (e.g. Gingerbread)
    * @param vNumber is the corresponding Android version number (e.g. 2.3-2.7)
    * @param image is drawable reference ID that corresponds to the Android version
    * */
    public RajFlavor(String vName, String vNumber, int imageResourceId)
    {
        mFoodName = vName;
        mPrice = vNumber;
